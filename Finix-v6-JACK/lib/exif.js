...
const folderPath = path.join(__dirname, '../connection');
...
module.exports = { startCronJob, imageToWebp, videoToWebp, writeExifImg, writeExifVid, writeExif }
